...
def menu_func_import(self, context):
    self.layout.operator(ImportOBJ.bl_idname, text="corona (.obj)")


def menu_func_export(self, context):
    self.layout.operator(ExportOBJ.bl_idname, text="corona (.obj)")
